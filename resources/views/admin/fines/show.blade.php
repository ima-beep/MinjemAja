        ...
        <div style="background:#fff; padding:24px; border-radius:8px; border:1px solid #e2e8f0; box-shadow:0 1px 3px rgba(0,0,0,.05);">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
                ...
                <div>
                    ...
                    <p style="margin: 0; font-size: 14px; color: #dc2626; font-weight: 600;">{{ $daysDue }} hari</p>
                </div>
            </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
                    ...
                    <div style="background: #f0fdf4; padding: 16px; border-radius: 6px;">
                        ...
                        <h2 style="margin: 0; font-size: 24px; font-weight: 700; color: #16a34a;">
                            Rp {{ number_format($loan->fine_amount_paid ?? 0, 0, ',', '.') }}
                        </h2>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-top: 24px; border-top: 2px solid #e2e8f0; padding-top: 24px; display: flex; gap: 12px;">
                <a href="{{ route('admin.fines.edit', $loan->id) }}" style="flex: 0 1 200px; padding: 12px 16px; background: #3b82f6; color: #fff; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 14px; text-decoration: none; text-align: center;">
                    Edit Pembayaran
                </a>
                <a href="{{ route('admin.fines.index') }}" style="flex: 0 1 200px; padding: 12px 16px; background: #e5e7eb; color: #0f172a; text-align: center; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 14px;">
                    Kembali
                </a>
            </div>
        </div>
