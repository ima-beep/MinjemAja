                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            <tr style="border-bottom: 1px solid #e2e8f0;">
                                <td style="padding: 12px;">{{ $r->book->name }}</td>
                                ...
                                <td style="padding: 12px;">{{ $r->review ?? '-' }}</td>
                                <td style="padding: 12px;">
                                    <form method="POST" action="{{ route('admin.reviews.destroy', $r->id) }}" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
