                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        @foreach($fines as $fine)
                                <tr style="border-bottom: 1px solid #e2e8f0;">
                                    ...
                                    <td style="padding: 12px;">
                                        <a href="{{ route('teacher.fines.edit', $fine->id) }}" style="background: #3b82f6; color: #fff; padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 12px; font-weight: 600; display: inline-block; margin-right: 8px;">
                                            Edit
                                        </a>
                                        <a href="{{ route('teacher.fines.show', $fine->id) }}" style="background: #6366f1; color: #fff; padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 12px; font-weight: 600; display: inline-block;">
                                            Detail
                                        </a>
                                    </td>
                                </tr>
