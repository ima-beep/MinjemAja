    ...
    <div style="flex: 1; display: flex; flex-direction: column; padding: 20px;">
        ...
        <div style="background:#fff; padding:24px; border-radius:8px; border:1px solid #e2e8f0; box-shadow:0 1px 3px rgba(0,0,0,.05);">
            ...
            <div style="margin-top: 24px; border-top: 2px solid #e2e8f0; padding-top: 24px; display: flex; gap: 12px;">
                <a href="{{ route('teacher.fines.edit', $loan->id) }}" style="flex: 0 1 200px; padding: 12px 16px; background: #3b82f6; color: #fff; border: none; border-radius: 6px; font-weight: 600; cursor: pointer; font-size: 14px; text-decoration: none; text-align: center;">
                    Edit Pembayaran
                </a>
