...
<div style="max-width: 100%;">
    ...
    <div style="display:grid; grid-template-columns:repeat(4, 1fr); gap:16px;">
        @forelse($books as $book)
            <div data-url="{{ route('student.books.show', $book->id) }}" style="border:1px solid #e2e8f0; border-radius:8px; overflow:hidden; cursor:pointer; transition:all 0.3s ease; height:100%;" 
                ...
                <div style="padding:12px;">
                    <h4 style="margin:0 0 4px; font-size:14px; font-weight:600;">{{ $book->name }}</h4>
