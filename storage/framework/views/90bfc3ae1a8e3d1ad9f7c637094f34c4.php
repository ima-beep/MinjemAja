...
<?php $__env->startSection('title', 'Tambah Pengarang'); ?>
<?php $__env->startSection('page_title', 'Tambah Pengarang Baru'); ?>
...
<div style="width: 76vw; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc; margin: 0; padding: 0; overflow-x: hidden;">
  <div style="flex: 1; display: flex; flex-direction: column; padding: 20px 0; margin: 0;">
    ...
    <form method="POST" action="<?php echo e(route('teacher.authors.store')); ?>" enctype="multipart/form-data"
      ...
      <div style="display: flex; flex-direction: column; gap: 18px; width: 100%;">
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="text" name="name" placeholder="Masukkan nama pengarang" value="<?php echo e(old('name')); ?>" required
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="text" name="nationality" placeholder="Masukkan kewarganegaraan" value="<?php echo e(old('nationality')); ?>"
            style="width: 100% !important; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; box-sizing: border-box;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <textarea name="biography" placeholder="Masukkan biografi pengarang" rows="6"
            style="width: 100% !important; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; font-family: inherit; resize: vertical; box-sizing: border-box;"><?php echo e(old('biography')); ?></textarea>
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/teacher/authors/create.blade.php ENDPATH**/ ?>