...
<div style="max-width: 1400px;">
    ...
    <div style="margin-bottom: 24px;">
        <a href="<?php echo e(route('teacher.books.create')); ?>"
            ...
            <div style="background:#fff; border-radius:8px; overflow:hidden;
                ...
                <div style="padding:12px; flex:1; display:flex; flex-direction:column;">
                    ...
                    <div style="display:flex; gap:6px; margin-top:auto; padding-top:8px;">
                        <a href="<?php echo e(route('teacher.books.edit', $book->id)); ?>"
                        ...
                        <form method="POST"
                              action="<?php echo e(route('teacher.books.destroy', $book->id)); ?>"
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/teacher/books/index.blade.php ENDPATH**/ ?>