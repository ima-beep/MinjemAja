...
<?php $__env->startSection('page_title', 'Manajemen Kategori'); ?>
...
<div style="width: 76vw; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc; margin: 0; padding: 0; overflow-x: hidden;">
    <div style="flex: 1; display: flex; flex-direction: column; padding: 20px 0; margin: 0;">
        ...
        <div style="margin-bottom: 20px;">
            <a href="<?php echo e(route('teacher.categories.create')); ?>"
                ...
                <tbody>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border-bottom: 1px solid #e5e7eb;">
                            <td style="padding: 12px;"><strong><?php echo e($category->name); ?></strong></td>
                            <td style="padding: 12px;"><?php echo e($category->description ?? '-'); ?></td>
                            <td style="padding: 12px; text-align: center;">
                                <div style="display: flex; gap: 8px; justify-content: center;">
                                    <a href="<?php echo e(route('teacher.categories.edit', $category)); ?>"
                                       style="padding: 6px 12px; background: #3b82f6; color: #fff; border-radius: 4px; text-decoration: none; font-size: 12px; font-weight: 600;">
                                        Edit
                                    </a>
                                    <form method="POST" action="<?php echo e(route('teacher.categories.destroy', $category)); ?>" style="display: inline;">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/teacher/categories/index.blade.php ENDPATH**/ ?>