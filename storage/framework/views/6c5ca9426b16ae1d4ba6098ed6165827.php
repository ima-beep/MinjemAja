...
<div style="width: 76vw; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc; margin: 0; padding: 0; overflow-x: hidden;">
  <div style="flex: 1; display: flex; flex-direction: column; padding: 20px 0; margin: 0;">
    ...
    <form method="POST" action="<?php echo e(route('teacher.categories.update', $category)); ?>" enctype="multipart/form-data"
      ...
      <div style="display: flex; flex-direction: column; gap: 18px; width: 100%;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <textarea name="description" 
                      style="width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 14px; box-sizing: border-box; resize: vertical; min-height: 100px;"><?php echo e(old('description', $category->description)); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/teacher/categories/edit.blade.php ENDPATH**/ ?>