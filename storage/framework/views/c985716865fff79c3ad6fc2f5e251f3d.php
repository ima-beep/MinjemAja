...
<div style="width: 76vw; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc; margin: 0; padding: 0; overflow-x: hidden;">
    ...
    <div style="background:#fff;padding:24px;border-radius:10px;box-shadow:0 2px 8px rgba(0,0,0,.04);margin-bottom:24px;border-left:4px solid #f59e0b;">
        <h2 style="margin-top:0;color:#f59e0b;">
            ⏳ Permintaan Pengembalian Menunggu Persetujuan (<?php echo e($pendingReturns->count()); ?>)
        </h2>
                ...
                <tbody>
                    <?php $__currentLoopData = $pendingReturns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border-bottom:1px solid #fcd34d;background:#fffbeb;">
                            ...
                            <td style="padding:12px;">
                                <?php echo e(optional($loan->return_request_date)->format('d M Y') ?? '-'); ?>

                            </td>
                            <td style="padding:12px;text-align:center;">
                                <form method="POST" style="display:inline;">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" formaction="<?php echo e(route('admin.books.approve-return', $loan->id)); ?>"
                                    ...
                                    <button type="submit" formaction="<?php echo e(route('admin.books.reject-return', $loan->id)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/admin/loans/index.blade.php ENDPATH**/ ?>