...
<!-- ⚠️ HILANGKAN SEMUA WRAPPER YANG MEMBATASI LEBAR -->
<div style="width: 76vw; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc; margin: 0; padding: 0; overflow-x: hidden;">
  <div style="flex: 1; display: flex; flex-direction: column; padding: 20px 0; margin: 0;">
    <h1 style="font-size: 28px; font-weight: 700; margin-bottom: 24px; padding: 0;">📚 Tambah Buku Baru</h1>

    <!-- FORM TANPA CARD, TANPA PADDING EKSTRA -->
    <form method="POST" action="<?php echo e(route('teacher.books.store')); ?>" enctype="multipart/form-data"
      style="margin: 0; padding: 0; width: 100%; box-sizing: border-box;">

      <?php echo csrf_field(); ?>

      <!-- 🔥 SETIAP FIELD DIJAMIN 100% LEBAR — TIDAK ADA GRID, TIDAK ADA CONTAINER DALAM -->
      <div style="display: flex; flex-direction: column; gap: 18px; width: 100%;">
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="text" name="name" placeholder="Masukkan judul buku" value="<?php echo e(old('name')); ?>" required
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <textarea name="description" placeholder="Masukkan deskripsi atau sinopsis buku" rows="4"
            style="width: 100% !important; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; font-family: inherit; resize: vertical; box-sizing: border-box;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="number" name="tahun" value="<?php echo e(old('tahun')); ?>" required
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="number" name="stok" value="<?php echo e(old('stok')); ?>" required min="0"
...
unset($__errorArgs, $__bag); ?>
      ...
      <div style="display: flex; gap: 12px; margin-top: 32px;">
        ...
        <a href="<?php echo e(route('teacher.books.index')); ?>"
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/teacher/books/create.blade.php ENDPATH**/ ?>