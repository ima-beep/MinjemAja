...
<?php $__env->startSection('page_title', 'Tambah Penerbit Baru'); ?>
...
<div style="width: 76vw; min-height: 100vh; display: flex; flex-direction: column; background: #f8fafc; margin: 0; padding: 0; overflow-x: hidden;">
  <div style="flex: 1; display: flex; flex-direction: column; padding: 20px 0; margin: 0;">
    ...
    <form method="POST" action="<?php echo e(route('teacher.publishers.store')); ?>" enctype="multipart/form-data"
      ...
      <div style="display: flex; flex-direction: column; gap: 18px; width: 100%;">
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="text" name="name" placeholder="Masukkan nama penerbit" value="<?php echo e(old('name')); ?>" required
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <textarea name="address" placeholder="Masukkan alamat penerbit" rows="3"
            style="width: 100% !important; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; font-family: inherit; resize: vertical; box-sizing: border-box;"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="text" name="phone" placeholder="Masukkan nomor telepon" value="<?php echo e(old('phone')); ?>"
            style="width: 100% !important; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; box-sizing: border-box;">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div style="width: 100% !important; margin: 0;">
          ...
          <input type="email" name="email" placeholder="Masukkan alamat email" value="<?php echo e(old('email')); ?>"
            style="width: 100% !important; padding: 10px 12px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; box-sizing: border-box;">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div style="display: flex; gap: 12px; margin-top: 32px;">
        ...
        <a href="<?php echo e(route('teacher.publishers.index')); ?>"
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/teacher/publishers/create.blade.php ENDPATH**/ ?>