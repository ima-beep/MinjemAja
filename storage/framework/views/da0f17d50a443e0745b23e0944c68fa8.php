...
<div class="card">
    ...
    <?php if(session('success')): ?>
        <div style="background:#d1fae5;border:1px solid #10b981;color:#065f46;padding:12px 16px;border-radius:8px;margin-bottom:20px;font-size:14px;"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    ...
    <!-- FORM SISWA -->
    <form id="siswa-form" method="POST" action="<?php echo e(route('login')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div style="text-align: center; margin-top: 16px; color: #64748b; font-size: 13px;">
            Siswa tapi belum punya akun? <a href="<?php echo e(route('register')); ?>" style="color: #2563eb; text-decoration: none; font-weight: 600;">Daftar dulu deh!</a>
        </div>
    </form>
...
<?php /**PATH C:\xampp\htdocs\ukk-peminjaman-buku\resources\views/auth/login.blade.php ENDPATH**/ ?>